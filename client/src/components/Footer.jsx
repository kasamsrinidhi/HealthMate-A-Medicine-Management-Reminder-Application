        ...
        <div className="grid w-full justify-between sm:flex md:grid-cols-1">
          ...
          <div className="grid grid-cols-2 gap-8 mt-4 sm:grid-cols-3 sm:gap-6">
            ...
            <div>
              ...
              <Footer.LinkGroup col>
                <Footer.Link
                  href="https://www.linkedin.com/in/srinidhi-kasam-748794269/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  LinkedIn
                ...
                <Footer.Link
                  href="https://github.com/kasamsrinidhi"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  GitHub
        ...
        <div className="w-full sm:flex sm:items-center sm:justify-between ">
            <Footer.Copyright href="#" by="HealthMate" year={new Date().getFullYear()} />
             <div className="flex gap-6 sm:mt-0 mt-4 sm:justify-center">
                ...
                <Footer.Icon href="https://github.com/kasamsrinidhi" icon={BsGithub} />
